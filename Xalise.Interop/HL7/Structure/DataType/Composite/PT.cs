...
namespace Xalise.Interop.HL7.Structure.DataType.Composite
{
    ...
    public class PT : AbstractTypeComposite
    {
        ...
        {
            this.SetComponent(1, new ID("Processing Id", 1, EnumDataUsage.OPTIONAL, TableCodeDefinition.T0103_PROCESSING_ID));
            this.SetComponent(2, new ID("Processing Mode", 1, EnumDataUsage.OPTIONAL, TableCodeDefinition.T0207_PROCESSING_MODE));
        }
