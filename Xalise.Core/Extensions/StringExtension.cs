...
{
    /// <summary>
    /// Méthodes d'extension applicables au type <see cref="string"/>.
    /// </summary>
    public static class StringExtension
    {
        ...
        /// <summary>
        /// Indique si la chaîne n'est pas <see langword="null"/>, vide (<c>""</c> ou <see cref="string.Empty"/>) ou composée uniquement d'espaces.
        /// </summary>
        /// <param name="src">Chaîne à tester.</param>
        /// <returns><see langword="true"/> si la chaîne n'est pas <see langword="null"/>, vide (<c>""</c> ou <see cref="string.Empty"/>) ou composée uniquement d'espaces ; sinon <see langword="false"/>.</returns>
